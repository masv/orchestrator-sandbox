...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "scripts/base-install.sh"
  ...
  config.vm.define "db4" do |node|
    ...
    node.vm.network :private_network, ip: "192.168.58.14"
  end
